...
b_4=tkinter.Button(calculator,text="4",borderwidth=1,font=("Arial",20))
b_4.grid(row=3,column=0,sticky="NWNESWSE")

b_5=tkinter.Button(calculator,text="5",borderwidth=1,font=("Arial",20))
b_5.grid(row=3,column=1,sticky="NWNESWSE")

b_6=tkinter.Button(calculator,text="6",borderwidth=1,font=("Arial",20))
b_6.grid(row=3,column=2,sticky="NWNESWSE")

b_minus=tkinter.Button(calculator,text="-",borderwidth=1,font=("Arial",20))
b_minus.grid(row=3,column=3,sticky="NWNESWSE")

# ROW 4 ------------------------------------------------------------------------

b_1=tkinter.Button(calculator,text="1",borderwidth=1,font=("Arial",20))
b_1.grid(row=4,column=0,sticky="NWNESWSE")

b_2=tkinter.Button(calculator,text="2",borderwidth=1,font=("Arial",20))
b_2.grid(row=4,column=1,sticky="NWNESWSE")

b_3=tkinter.Button(calculator,text="3",borderwidth=1,font=("Arial",20))
b_3.grid(row=4,column=2,sticky="NWNESWSE")

b_plus=tkinter.Button(calculator,text="+",borderwidth=1,font=("Arial",20))
b_plus.grid(row=4,column=3,sticky="NWNESWSE")


# last row
b_0=tkinter.Button(calculator,text="0",font=("Arial",20),borderwidth= 1)
